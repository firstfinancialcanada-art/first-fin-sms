...
const DEMO_CRM = [
  {id:'d1',name:'James Thornton',phone:'+14035550101',email:'jthornton@example.com',status:'Test Drive',score:680,income:6200,vehicle:'2022 Toyota RAV4',date:'2024-01-14',beacon:680,stock:'MAG-1002',created_at:new Date(Date.now()-2*86400000).toISOString()},
  {id:'d2',name:'Sarah Mitchell',phone:'+14035550102',email:'smitchell@example.com',status:'Negotiating',score:720,income:7800,vehicle:'2021 Ford F-150',date:'2024-01-15',beacon:720,stock:'MAG-1001',created_at:new Date(Date.now()-1*86400000).toISOString()},
  {id:'d3',name:'David Park',phone:'+14035550103',email:'dpark@example.com',status:'Sold',score:760,income:9100,vehicle:'2023 Chevrolet Silverado',date:'2024-01-10',beacon:760,stock:'MAG-1004',created_at:new Date(Date.now()-5*86400000).toISOString()},
  {id:'d4',name:'Lisa Chen',phone:'+14035550104',email:'lchen@example.com',status:'Contacted',score:640,income:5400,vehicle:'2020 Honda Civic',date:'2024-01-13',beacon:640,stock:'MAG-1003',created_at:new Date(Date.now()-3*86400000).toISOString()},
  {id:'d5',name:'Marcus Williams',phone:'+14035550105',email:'mwilliams@example.com',status:'Lead',score:695,income:6800,vehicle:'2021 Hyundai Tucson',date:'2024-01-16',beacon:695,stock:'MAG-1005',created_at:new Date(Date.now()-86400000/2).toISOString()},
  {id:'d6',name:'Rachel Torres',phone:'+14035550106',email:'rtorres@example.com',status:'Test Drive',score:740,income:8200,vehicle:'2019 Jeep Wrangler',date:'2024-01-12',beacon:740,stock:'MAG-1006',created_at:new Date(Date.now()-4*86400000).toISOString()},
  {id:'d7',name:'Kevin OBrien',phone:'+14035550107',email:'kobrien@example.com',status:'Sold',score:780,income:10500,vehicle:'2023 Chevrolet Silverado',date:'2024-01-09',beacon:780,stock:'MAG-1004',created_at:new Date(Date.now()-6*86400000).toISOString()},
  {id:'d8',name:'Priya Sharma',phone:'+14035550108',email:'psharma@example.com',status:'Contacted',score:660,income:5900,vehicle:'2022 Toyota RAV4',date:'2024-01-11',beacon:660,stock:'MAG-1002',created_at:new Date(Date.now()-4*86400000+3600000).toISOString()},
  {id:'d9',name:'Amanda Cole',phone:'+14035550109',email:'acole@example.com',status:'Sold',score:710,income:7200,vehicle:'2020 Honda Civic Sport',date:'2024-01-08',beacon:710,stock:'MAG-1003',created_at:new Date(Date.now()-5*86400000).toISOString()},
  {id:'d10',name:'Derek Haines',phone:'+14035550110',email:'dhaines@example.com',status:'Negotiating',score:690,income:6500,vehicle:'2021 Ford F-150 XLT',date:'2024-01-15',beacon:690,stock:'MAG-1001',created_at:new Date(Date.now()-1*86400000).toISOString()},
  {id:'d11',name:'Jason Firth',phone:'+14035550111',email:'jfirth@example.com',status:'Test Drive',score:650,income:5800,vehicle:'2021 Hyundai Tucson',date:'2024-01-14',beacon:650,stock:'MAG-1005',created_at:new Date(Date.now()-2*86400000).toISOString()},
  {id:'d12',name:'Samira Youssef',phone:'+14035550112',email:'syoussef@example.com',status:'Lead',score:735,income:8900,vehicle:'2019 Jeep Wrangler',date:'2024-01-16',beacon:735,stock:'MAG-1006',created_at:new Date(Date.now()-0.5*86400000).toISOString()},
];
