      ...
      if(SARAH_PATHS.some(p => path.startsWith(p))) {
        ...
        if(path === '/api/conversations' || path.startsWith('/api/conversations')) {
          const DEMO_CONVS = [
            ...
            {customer_phone:'+14035550102',customer_name:'Sarah Mitchell',status:'active',stage:'Negotiating',vehicle_type:'Truck',budget:'$35,000–$45,000',message_count:11,last_message:'What\'s the best you can do on payments?',updated_at:new Date(Date.now()-3600000).toISOString()},
            ...
            {customer_phone:'+14035550104',customer_name:'Lisa Chen',status:'active',stage:'Interested',vehicle_type:'Car',budget:'$20,000–$25,000',message_count:5,last_message:'Do you have anything in red?',updated_at:new Date(Date.now()-3*86400000).toISOString()},
            ...
            {customer_phone:'+14035550108',customer_name:'Priya Sharma',status:'active',stage:'Callback Requested',vehicle_type:'SUV',budget:'$30,000–$35,000',message_count:4,last_message:'Call me anytime after 2pm',updated_at:new Date(Date.now()-1*86400000).toISOString()},
