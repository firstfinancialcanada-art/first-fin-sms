...
- Wholesale photo signage (2026-09-23): SmartBuy's shop sign shows in some of their vehicle photos. The screening that was meant to catch it never worked (0 of 6 flagged); it now scans each photo in tiles, flags the sign, runs only on wholesale cars, caches each verdict, and Auto-Fill won't send a wholesale listing whose scan hasn't finished.
