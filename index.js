...
if (!process.env.TWILIO_ACCOUNT_SID || !process.env.TWILIO_AUTH_TOKEN || !process.env.TWILIO_PHONE_NUMBER) {
  console.error('⚠️⚠️⚠️ CRITICAL: TWILIO CREDENTIALS MISSING! ⚠️⚠️⚠️');
  console.error('Bulk SMS will NOT work. Set TWILIO_ACCOUNT_SID, TWILIO_AUTH_TOKEN, TWILIO_PHONE_NUMBER in .env');
} else {
  console.log('✅ Twilio credentials configured');
  console.log('   Account: ' + process.env.TWILIO_ACCOUNT_SID.substring(0, 10) + '...');
